<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPager.Master" CodeBehind="Colores_Listar.aspx.vb" Inherits="ProyectoWeb.Colores_Listar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <img src="Assets/linkedin_banner_image_2.png" width="1300" height="440"/>
    <%--<center>
            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body table-responsive">
                          <div class="col-lg-3">
                                        <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="fnAgregar()">Agregar Color</button>
                                
                                         </div>

                         <asp:GridView ID="GdvColores" runat="server"  AllowPaging="True" AutoGenerateColumns="False" CssClass="grid aej_all table table-striped table-bordered dt-responsive dataTable no-footer" 
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabelAgregar">Agregar Color</h4>
                </div>
