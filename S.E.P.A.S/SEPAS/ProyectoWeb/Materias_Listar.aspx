<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPager.Master" CodeBehind="Materias_Listar.aspx.vb" Inherits="ProyectoWeb.Marcas_Listar" %>
            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body table-responsive">
                          <div class="col-lg-3">
                                        <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="fnAgregar()">Agregar Materias</button>
                                
                                         </div>

                         <asp:GridView ID="GdvMarcas" runat="server"  AllowPaging="True" AutoGenerateColumns="False" CssClass="grid aej_all table table-striped table-bordered dt-responsive dataTable no-footer" 
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabelAgregar">Agregar Marca</h4>
                </div>
         ...
         <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="panel-heading" style="background-color: #1ab394; color: white;">Eliminar Marca
                         ...
                         <div class="col-lg-12">
                                        <div class="form-group">
                                          <asp:TextBox ID="ColorEliminar" clientIdmode="static"  CssClass="form-control"  runat="server" ReadOnly="true" visible="TRUE"></asp:TextBox>
                                            ...
                                            <label for="dgdsg" class="control-label">Marca</label>
