            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Lista de Tipo de Autos</h3>
                    </div>
                    <div class="box-body table-responsive">
                          <div class="col-lg-3">
                                        <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="fnAgregar()">Agregar Tipo</button>
                                
                                         </div>

                         <asp:GridView ID="GdvTipoAutos" runat="server"  AllowPaging="True" AutoGenerateColumns="False" CssClass="grid aej_all table table-striped table-bordered dt-responsive dataTable no-footer" 
                 ...
                 <asp:GridView ID="GdvColores" AutoGenerateColumns="false" CssClass="table table-active table-bordered" runat="server">--%>
                     ...
                     <Columns>
                      ...
                      <asp:ButtonField  HeaderText="Editar"     Text="<i class='fa fa-cog icon-large fa-1x'></i>" CommandName="Editar"/>    
                        <%-- Text="<i class='fa fa-cog icon-large fa-1x'></i>"--%>
