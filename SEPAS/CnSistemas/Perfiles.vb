...
'fecha generación: 10/12/2022 18:49:14
...
#Region "Propiedades" 
    ...
    Public Property Usuarios() As Decimal 
		Get 
			Return _Usuarios 
		End Get 
...
Public Function Insert(ByVal obj As Perfiles, Optional ByVal oArgsLogueo As Object = Nothing) As Perfiles
    Dim Resp As New Perfiles
    Try
            Dim oSvr As New ServidorDatosNet_GNA.svr("SEPAS_DES", "Perfiles", "USUARIO")
...
Public Function Update(ByVal obj As Perfiles, Optional ByVal oArgsLogueo As Object = Nothing) As Perfiles
    Dim Resp As Integer = 0
    Dim oRegistroActual As New Perfiles
    Try
            Dim oSvr As New ServidorDatosNet_GNA.svr("SEPAS_DES", "Perfiles", "USUARIO")
...
Public Function Delete(ByVal ID As Integer) As Integer
        Dim oDato As New ServidorDatosNet_GNA.svr("SEPAS_DES", "Perfiles", "USUARIO")
        Try
...
Public Function Lista(ByVal Sp As String, ByVal ParamArray Parametros() As Object) As DataSet
        Dim oDatos As New ServidorDatosNet_GNA.svr("SEPAS_DES", "Perfiles", "USUARIO")
        Dim ds As New DataSet
    Try
...
Public Function Obtener_registro(ByVal ID As Integer) As Perfiles
        Dim oSvr As New ServidorDatosNet_GNA.svr("SEPAS_DES", "Perfiles", "USUARIO")
        Dim ds As New DataSet
   Dim oPerfiles  As New Perfiles
   Try
       oPerfiles = oSvr.ObtenerRegistro(oPerfiles, ID)
       If oPerfiles.ID <= 0 Then
...
Public Function Lista_Perfiles(ByVal query As String) As List(Of Perfiles)
        Dim oDatos As New ServidorDatosNet_GNA.svr("SEPAS_DES", "Perfiles", "USUARIO")
        Dim Lst_Perfiles As List(Of Perfiles)
Try
   Lst_Perfiles = oDatos.Lista_Obj(Of Perfiles)(query)
Catch ex As Exception
   Throw ex 
End Try
Return Lst_Perfiles
