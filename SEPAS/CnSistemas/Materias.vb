...
'fecha generación: 10/12/2022 18:49:13
...
#Region "Variables" 
	...
	Private _IdTipoModalidad As Integer 
...
#Region "Propiedades" 
    ...
    Public Property IdTipoModalidad() As Integer 
		Get 
...
Public Function Insert(ByVal obj As Materias, Optional ByVal oArgsLogueo As Object = Nothing) As Materias
    Dim Resp As New Materias
    Try
            Dim oSvr As New ServidorDatosNet_GNA.svr("SEPAS_DES", "Materias", "USUARIO")
...
Public Function Update(ByVal obj As Materias, Optional ByVal oArgsLogueo As Object = Nothing) As Materias
    Dim Resp As Integer = 0
    Dim oRegistroActual As New Materias
    Try
            Dim oSvr As New ServidorDatosNet_GNA.svr("SEPAS_DES", "Materias", "USUARIO")
...
Public Function Delete(ByVal ID As Integer) As Integer
        Dim oDato As New ServidorDatosNet_GNA.svr("SEPAS_DES", "Materias", "USUARIO")
        Try
...
Public Function Lista(ByVal Sp As String, ByVal ParamArray Parametros() As Object) As DataSet
        Dim oDatos As New ServidorDatosNet_GNA.svr("SEPAS_DES", "Materias", "USUARIO")
        Dim ds As New DataSet
    Try
...
Public Function Obtener_registro(ByVal ID As Integer) As Materias
        Dim oSvr As New ServidorDatosNet_GNA.svr("SEPAS_DES", "Materias", "USUARIO")
        Dim ds As New DataSet
   Dim oMaterias  As New Materias
   Try
       oMaterias = oSvr.ObtenerRegistro(oMaterias, ID)
       If oMaterias.ID <= 0 Then
...
Public Function Lista_Materias(ByVal query As String) As List(Of Materias)
        Dim oDatos As New ServidorDatosNet_GNA.svr("SEPAS_DES", "Materias", "USUARIO")
        Dim Lst_Materias As List(Of Materias)
Try
   Lst_Materias = oDatos.Lista_Obj(Of Materias)(query)
Catch ex As Exception
   Throw ex 
End Try
Return Lst_Materias
