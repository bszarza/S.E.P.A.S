...
Public Function Insert(ByVal obj As TipoCursos, Optional ByVal oArgsLogueo As Object = Nothing) As TipoCursos
    ...
    Try
            Dim oSvr As New ServidorDatosNet_GNA.svr("SEPAS_DES", "TipoCursos", "USUARIO")
...
Public Function Delete(ByVal ID As Integer) As Integer
        Dim oDato As New ServidorDatosNet_GNA.svr("SEPAS_DES", "TipoCursos", "USUARIO")
        Try
...
Public Function Lista(ByVal Sp As String, ByVal ParamArray Parametros() As Object) As DataSet
        Dim oDatos As New ServidorDatosNet_GNA.svr("SEPAS_DES", "TipoCursos", "USUARIO")
        Dim ds As New DataSet
    Try
