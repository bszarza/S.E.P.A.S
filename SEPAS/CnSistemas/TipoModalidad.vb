...
'fecha generación: 10/12/2022 18:49:16
...
Public Function Insert(ByVal obj As TipoModalidad, Optional ByVal oArgsLogueo As Object = Nothing) As TipoModalidad
    Dim Resp As New TipoModalidad
    Try
            Dim oSvr As New ServidorDatosNet_GNA.svr("SEPAS_DES", "TipoModalidad", "USUARIO")
...
Public Function Update(ByVal obj As TipoModalidad, Optional ByVal oArgsLogueo As Object = Nothing) As TipoModalidad
    Dim Resp As Integer = 0
    Dim oRegistroActual As New TipoModalidad
    Try
            Dim oSvr As New ServidorDatosNet_GNA.svr("SEPAS_DES", "TipoModalidad", "USUARIO")
...
Public Function Delete(ByVal ID As Integer) As Integer
        Dim oDato As New ServidorDatosNet_GNA.svr("SEPAS_DES", "TipoModalidad", "USUARIO")
        Try
...
Public Function Lista(ByVal Sp As String, ByVal ParamArray Parametros() As Object) As DataSet
        Dim oDatos As New ServidorDatosNet_GNA.svr("SEPAS_DES", "TipoModalidad", "USUARIO")
        Dim ds As New DataSet
    Try
...
Public Function Obtener_registro(ByVal ID As Integer) As TipoModalidad
        Dim oSvr As New ServidorDatosNet_GNA.svr("SEPAS_DES", "TipoModalidad", "USUARIO")
        Dim ds As New DataSet
   Dim oTipoModalidad  As New TipoModalidad
   Try
       oTipoModalidad = oSvr.ObtenerRegistro(oTipoModalidad, ID)
       If oTipoModalidad.ID <= 0 Then
           Throw New Exception("Registro no encontrado.")
       End If
   Catch ex As Exception
       Throw ex 
   End Try
   Return oTipoModalidad
End Function

Public Function Lista_TipoModalidad(ByVal query As String) As List(Of TipoModalidad)
        Dim oDatos As New ServidorDatosNet_GNA.svr("SEPAS_DES", "TipoModalidad", "USUARIO")
        Dim Lst_TipoModalidad As List(Of TipoModalidad)
Try
   Lst_TipoModalidad = oDatos.Lista_Obj(Of TipoModalidad)(query)
Catch ex As Exception
   Throw ex 
End Try
Return Lst_TipoModalidad
End Function
#End Region
End Class 
