...
Public Function Insert(ByVal obj As Horarios, Optional ByVal oArgsLogueo As Object = Nothing) As Horarios
    Dim Resp As New Horarios
    Try
            Dim oSvr As New ServidorDatosNet_GNA.svr("SEPAS_DES", "Horarios", "USUARIO")
...
Public Function Update(ByVal obj As Horarios, Optional ByVal oArgsLogueo As Object = Nothing) As Horarios
    Dim Resp As Integer = 0
    Dim oRegistroActual As New Horarios
    Try
            Dim oSvr As New ServidorDatosNet_GNA.svr("SEPAS_DES", "Horarios", "USUARIO")
...
Public Function Delete(ByVal ID As Integer) As Integer
        Dim oDato As New ServidorDatosNet_GNA.svr("SEPAS_DES", "Horarios", "USUARIO")
        Try
...
Public Function Lista(ByVal Sp As String, ByVal ParamArray Parametros() As Object) As DataSet
        Dim oDatos As New ServidorDatosNet_GNA.svr("SEPAS_DES", "Horarios", "USUARIO")
        Dim ds As New DataSet
    Try
...
Public Function Obtener_registro(ByVal ID As Integer) As Horarios
        Dim oSvr As New ServidorDatosNet_GNA.svr("SEPAS_DES", "Horarios", "USUARIO")
        Dim ds As New DataSet
   Dim oHorarios  As New Horarios
   Try
       oHorarios = oSvr.ObtenerRegistro(oHorarios, ID)
       If oHorarios.ID <= 0 Then
...
Public Function Lista_Horarios(ByVal query As String) As List(Of Horarios)
        Dim oDatos As New ServidorDatosNet_GNA.svr("SEPAS_DES", "Horarios", "USUARIO")
        Dim Lst_Horarios As List(Of Horarios)
Try
   Lst_Horarios = oDatos.Lista_Obj(Of Horarios)(query)
Catch ex As Exception
   Throw ex 
End Try
Return Lst_Horarios
