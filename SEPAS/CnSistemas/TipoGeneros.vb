...
Public Function Insert(ByVal obj As TipoGeneros, Optional ByVal oArgsLogueo As Object = Nothing) As TipoGeneros
    Dim Resp As New TipoGeneros
    Try
            Dim oSvr As New ServidorDatosNet_GNA.svr("SEPAS_DES", "TipoGeneros", "USUARIO")
...
Public Function Update(ByVal obj As TipoGeneros, Optional ByVal oArgsLogueo As Object = Nothing) As TipoGeneros
    Dim Resp As Integer = 0
    Dim oRegistroActual As New TipoGeneros
    Try
            Dim oSvr As New ServidorDatosNet_GNA.svr("SEPAS_DES", "TipoGeneros", "USUARIO")
...
Public Function Delete(ByVal ID As Integer) As Integer
        Dim oDato As New ServidorDatosNet_GNA.svr("SEPAS_DES", "TipoGeneros", "USUARIO")
        Try
...
Public Function Lista(ByVal Sp As String, ByVal ParamArray Parametros() As Object) As DataSet
        Dim oDatos As New ServidorDatosNet_GNA.svr("SEPAS_DES", "TipoGeneros", "USUARIO")
        Dim ds As New DataSet
    Try
...
Public Function Obtener_registro(ByVal ID As Integer) As TipoGeneros
        Dim oSvr As New ServidorDatosNet_GNA.svr("SEPAS_DES", "TipoGeneros", "USUARIO")
        Dim ds As New DataSet
   Dim oTipoGeneros  As New TipoGeneros
   Try
       oTipoGeneros = oSvr.ObtenerRegistro(oTipoGeneros, ID)
       If oTipoGeneros.ID <= 0 Then
...
Public Function Lista_TipoGeneros(ByVal query As String) As List(Of TipoGeneros)
        Dim oDatos As New ServidorDatosNet_GNA.svr("SEPAS_DES", "TipoGeneros", "USUARIO")
        Dim Lst_TipoGeneros As List(Of TipoGeneros)
Try
   Lst_TipoGeneros = oDatos.Lista_Obj(Of TipoGeneros)(query)
Catch ex As Exception
   Throw ex 
End Try
Return Lst_TipoGeneros
End Function
#End Region
End Class 
