...
Public Function Insert(ByVal obj As Horarios, Optional ByVal oArgsLogueo As Object = Nothing) As Horarios
    ...
    Try
    Dim oSvr As New ServidorDatosNet_GNA.svr("SEPAS", "Horarios", obj.USUARIO)
...
Public Function EjecutarSp (ByVal sp As String, byval Usuario as String, ByVal ParamArray Parametros() As Object) As System.Data.DataSet
    ...
    Try
    Dim oSvr As New ServidorDatosNet_GNA.svr("SEPAS", "Horarios", Usuario)
...
Public Function Delete(ByVal ID As Integer) As Integer
    Dim oDato As New ServidorDatosNet_GNA.svr("SEPAS","Horarios", "USUARIO")
    Try
