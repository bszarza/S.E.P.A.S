...
Public Function Insert(ByVal obj As TipoModalidad, Optional ByVal oArgsLogueo As Object = Nothing) As TipoModalidad
    ...
    Try
    Dim oSvr As New ServidorDatosNet_GNA.svr("SEPAS", "TipoModalidad", obj.USUARIO)
...
Public Function EjecutarSp (ByVal sp As String, byval Usuario as String, ByVal ParamArray Parametros() As Object) As System.Data.DataSet
    ...
    Try
    Dim oSvr As New ServidorDatosNet_GNA.svr("SEPAS", "TipoModalidad", Usuario)
...
Public Function Delete(ByVal ID As Integer) As Integer
    Dim oDato As New ServidorDatosNet_GNA.svr("SEPAS","TipoModalidad", "USUARIO")
    Try
