...
Public Function Insert(ByVal obj As TipoGeneros, Optional ByVal oArgsLogueo As Object = Nothing) As TipoGeneros
    ...
    Try
    Dim oSvr As New ServidorDatosNet_GNA.svr("SEPAS", "TipoGeneros", obj.USUARIO)
...
Public Function EjecutarSp (ByVal sp As String, byval Usuario as String, ByVal ParamArray Parametros() As Object) As System.Data.DataSet
    ...
    Try
    Dim oSvr As New ServidorDatosNet_GNA.svr("SEPAS", "TipoGeneros", Usuario)
...
Public Function Delete(ByVal ID As Integer) As Integer
    Dim oDato As New ServidorDatosNet_GNA.svr("SEPAS","TipoGeneros", "USUARIO")
    Try
