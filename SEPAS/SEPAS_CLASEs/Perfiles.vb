...
Public Function Insert(ByVal obj As Perfiles, Optional ByVal oArgsLogueo As Object = Nothing) As Perfiles
    ...
    Try
    Dim oSvr As New ServidorDatosNet_GNA.svr("SEPAS", "Perfiles", obj.USUARIO)
...
Public Function EjecutarSp (ByVal sp As String, byval Usuario as String, ByVal ParamArray Parametros() As Object) As System.Data.DataSet
    ...
    Try
    Dim oSvr As New ServidorDatosNet_GNA.svr("SEPAS", "Perfiles", Usuario)
...
Public Function Delete(ByVal ID As Integer) As Integer
    Dim oDato As New ServidorDatosNet_GNA.svr("SEPAS","Perfiles", "USUARIO")
    Try
